               ...
               <!------------------------------------ 페이징 시작 ------------------------------------>
						...
						<!------------------------------------ "이전" 구현 ------------------------------------>
							<c:if test="${ blockNo2 != 1 }"> 
								<a href="<%=request.getContextPath()%>/emp/loanEval/loanHis?blockNo2=${ blockNo2 -1 }&pageNo2=${ blockStartPageNo2-1 }" >이전</a> &nbsp; 
							</c:if>
						<!------------------------------------ 페이지 구현 ------------------------------------>
						...
						<c:if test="${ blockNo2 != totalBlockCnt2}">&nbsp;
							<a href="<%=request.getContextPath()%>/emp/loanEval/loanHis?blockNo2=${ blockNo2+1 }&pageNo2=${ blockEndPageNo2+1 }" >다음</a> &nbsp; 
						</c:if>
						</div>
						<!------------------------------------ 페이징 끝 ------------------------------------>

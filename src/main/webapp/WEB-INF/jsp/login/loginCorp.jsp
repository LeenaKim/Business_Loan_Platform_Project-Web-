...
function doLogin() {
	...
	if(isNull(lf.bizrNo, '사업자등록번호를 입력하세요.'))
		return false;
...
<body data-spy="scroll" data-target=".site-navbar-target">
	...
	<div class="container" id="changeable" align="center">
		...
		<form action="${ pageContext.request.contextPath }/loginCorp" method="post" name="loginForm" onsubmit="return doLogin();"> 
			<input name="bizrNo" class="input" type="text" placeholder="사업자등록번호"/><br>
